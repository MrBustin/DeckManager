...
- 2026-06-13 added a Deposit button below the deck slot. It moves the inserted compatible deck's current cards into station storage for the selected preset, clears the deck through `CardDeckContainer`, and refreshes preset availability.
